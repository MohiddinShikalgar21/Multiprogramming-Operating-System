...
char M [300][4]; //this is physical meemory and not virtual memory
char IR [5]; //instruction resister
char R [5]; //general purpose resister
int IC; //instruction counter
int C; //toggle
int SI; //system/servise interrupt

struct PCB{     //process control block stores all info of process
    char JID[5];
    int TTL;
    int TLL; 
};
...
int PTR; //page table referance

int generated_no[100]; //keep track of 
